...
Un cop creada la funció detectem els indexs amb valors nul i els eliminem de les variables que s'utilitzaran per entrenar i avaluar el model:
...
train_y_no_na <- train_y[-iwn_train]
test_y_no_na <- test_class_raw$Survived
```
